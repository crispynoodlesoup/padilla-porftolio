...
const skillsList = [
  ...
  skill("Node.js_logo.svg",
    "Node.js",
    "The newest addition to this list, it's my first full step into the backend. I'm still an amateur, but it's made me capable of making dynamic, more complex user interfaces than ever before."),
